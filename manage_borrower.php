		...
		<form id="manage-borrower">
			...
			<div class="row form-group">
				<div class="col-md-6">
							...
							<textarea name="company" id="" cols="30" rows="2" class="form-control" required=""><?php echo isset($company) ? $company : '' ?></textarea>
				</div>
				<div class="col-md-5">
					<div class="">
			...
			<div class="row form-group">
				...
				<div class="col-md-5">
					<div class="">
						...
						<input type="num" class="form-control" name="comp_no" value="<?php echo isset($comp_no) ? $comp_no : '' ?>">
					</div>
				</div>
			</div>
		</form>
