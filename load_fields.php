...
$loan = $conn->query("SELECT l.*,concat(b.lastname,', ',b.firstname,' ',b.middlename)as name, b.contact_no, b.company from loan_list l inner join borrowers b on b.id = l.borrower_id where l.id = ".$loan_id);
