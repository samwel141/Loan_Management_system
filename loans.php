				...
				<table class="table table-bordered" id="loan-list">
					...
					<tbody>
						<?php
							...
							$qry = $conn->query("SELECT l.*,concat(b.lastname,', ',b.firstname,' ',b.middlename)as name, b.contact_no, b.company from loan_list l inner join borrowers b on b.id = l.borrower_id  order by id asc");
						 ...
						 <tr>
						 	...
						 	<td>
						 		...
						 		<p><small>Company :<b><?php echo $row['company'] ?></small></b></p>
						 	</td>
						 	<td>
